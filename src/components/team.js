        ...
        <div className="ceo">
          ...
          <div className="ceo-bio">
            ...
            <p>
              ...
              Widgt, specializing in high quality electronic development across
              a wide variety of industries. He’s worked in technology in a
              diverse range of industries, including process equipment, defense,
              IT, automotive, radio, and consumer electronics. He loves escaping
              technology as well, and has backpacked many parts of the
              Appalachian Trail, Glacier National Park, and the Sacred Valley in
              Peru. Beyond egg incubation, he also wants to found a combination
              tech incubator and monastery, which he affectionately refers to as
              a space cult - will he be the first to keep chickens on Mars?
            </p>
          </div>
        </div>
        <div className="ceo-2">
